    ...
    for task_name in tasks:
        for train_mode in train_modes:
            ...
            np.save(os.path.join(GLOBAL_PATH, 'analysis', 'artificial_dataset',
                                 f'train_loss_{full_task_name}_{train_mode}_{seed}_{0}_{max_epoch}_fit={FIT_ORDER}_pool={POOLED}.npy'), train_loss)
            np.save(os.path.join(GLOBAL_PATH, 'analysis', 'artificial_dataset',
                                 f'test_loss_{full_task_name}_{train_mode}_{seed}_{0}_{max_epoch}_fit={FIT_ORDER}_pool={POOLED}.npy'), test_loss)
